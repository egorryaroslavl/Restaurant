	...
	<nav class="navbar">
		<div class="container">
			<div class="navbar-header">
				...
				<a href="index.html" class="navbar-brand"><img src="/themes/semper/img/main_logo_black.png" alt="logo"></a>
				<a href="index.html" class="navbar-brand white"><img src="/themes/semper/img/main_logo.png" alt="logo"></a>
			</div>
			<div class="collapse navbar-collapse bs-example-js-navbar-scrollspy">
				...
				<ul id="nav" class="nav navbar-nav cl-effect-11">
					<li class="active"><a class="at-drop-down" href="/">Главная <i
								class="hidden-md hidden-lg fa fa-angle-down"></i></a>
					
					</li>
					<li><a href="/about-us">О нас</a></li>
					<li><a class="at-drop-down" href="blog.html">Pages <i
								class="hidden-md hidden-lg fa fa-angle-down"></i></a>
						<ul class="sub-menu">
							<li><a href="about-us-2.html">About Style 2</a></li>
							<li><a href="menu-2.html">Menu Style 2</a></li>
							<li><a href="/reservation">Reservation 2</a></li>
					...
					<li><a href="/reservation">Бронировать</a></li>
					<li><a href="events.html">Events</a></li>
					<li><a href="/menu">Меню</a>
						@if(count($menusData =\App\Models\Menu::menus())>0 )
							<ul class="sub-menu">
							@foreach($menusData as $item)
							<li><a href="/menu/{{$item->alias}}">{{$item->name}}</a></li>
							@endforeach
							</ul>
						@endif
