...
<div class="slider-area">
	<div class="pogoSlider">
		<div class="pogoSlider-slide" data-transition="fade" data-duration="1500" style="background:url(/themes/semper/img/slider/slide_1.jpg) no-repeat scroll 0 0 / cover;">
		...
		<div class="pogoSlider-slide" data-transition="fade" style="background:url(/themes/semper/img/slider/slide_2.jpg) no-repeat scroll 0 0 / cover;">
			...
			<h3 class="pogoSlider-slide-element" data-in="expand" data-out="expand" data-duration="2300"><a href="index.html#menu">Todays Menu</a></h3>
		</div>
		<div class="pogoSlider-slide" data-transition="fade" style="background:url(/themes/semper/img/slider/slide_3.jpg) no-repeat scroll 0 0 / cover;">
