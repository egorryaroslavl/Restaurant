		...
		<div class="row event-list">
			<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
				<div class="single-event">
					<div class="event-img">
						<img src="/themes/semper/img/event/event_1.jpg" alt="">
					</div>
					<div class="event-content">
						...
						<div class="event-details">
							...
							<p class="event-meta"><a href="index.html#">29 September 2017 </a>- 196 Manhattan, MY, USA</p>
				...
				<div class="single-event">
					<div class="event-img">
						<img src="/themes/semper/img/event/event_2.jpg" alt="">
					</div>
					<div class="event-content">
						<div class="event-date">
							<p><span>22</span>December</p>
