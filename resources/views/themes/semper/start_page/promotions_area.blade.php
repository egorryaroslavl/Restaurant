	...
	<div class="container wow fadeIn">
		...
		<div class="row">
			<div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
				<div class="single-promotions text-center">
					<div class="promotions-img">
						<img src="/themes/semper/img/promotions/promo_1.jpg" alt="">
					...
					<div class="promotions-details">
						...
						<a href="index.html#" class="read-more">Order now</a>
					</div>
				</div>
			</div>
			<div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
				<div class="single-promotions text-center">
					<div class="promotions-img">
						<img src="/themes/semper/img/promotions/promo_2.jpg" alt="">
						<div class="pakage-rate">
			...
			<div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
				<div class="single-promotions text-center">
					<div class="promotions-img">
						<img src="/themes/semper/img/promotions/promo_3.jpg" alt="">
						<div class="pakage-rate">
