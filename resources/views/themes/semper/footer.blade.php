			...
			<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
				<div class="footer-top section-padding text-center">
					<div class="footer-logo">
						<a href="index.html#"><img src="/themes/semper/img/footer_white_logo.png" alt=""></a>
					</div>
		...
		<div class="row">
			<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
				<div class="footer-menu">
					<ul>
						<li><a href="index.html#">Teams of use</a></li>
						<li><a href="index.html#">Privicy Policy</a></li>
			...
			<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
				<div class="footer-copyright">
					<p>&copy; 2017 <a href="index.html#">Owl Restaurant</a> All Right Reserved. Coded by <a href="http://themeforest.net/user/bdexpert">BDEXPERT</a>.</p>
				</div>
			</div>
		</div>
	</div>
